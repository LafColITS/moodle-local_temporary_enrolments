...
$plugin->version   = 2018092635;                    // The current plugin version (Date: YYYYMMDDXX).
...
$plugin->release   = '1.0.0-35.0'; // Pattern: [major].[minor].[patch]-[Moodle Version].[Moodle version specific patch].
