...
For example, v1.5.7-35.1 would be plugin veresion 1.5.7 for Moodle 35, and includes one Moodle 35 specific patch. It would have corresponding versions v1.5.7-34.X and v1.5.7-33.X.
